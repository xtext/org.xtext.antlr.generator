...
public class XtextAntlrUiGeneratorFragment extends AbstractAntlrGeneratorFragment {
	...
	public String[] getExportedPackagesUi(Grammar grammar) {
		return new String[]{
				GrammarUtil.getNamespace(grammar) + ".contentassist.antlr"
		};
	}
	...
	public static String getInternalLexerClassName(Grammar g) {
		return GrammarUtil.getNamespace(g) + ".contentassist.antlr.internal.Internal" + GrammarUtil.getName(g)	+ "Lexer";
	}

	public static String getInternalParserClassName(Grammar g) {
		return GrammarUtil.getNamespace(g) + ".contentassist.antlr.internal.Internal" + GrammarUtil.getName(g) + "Parser";
	}
